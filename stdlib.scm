...
(define fold-left (lambda (f acc lst) (if (null? lst) acc
                                                     (fold-left f (f acc (car lst)) (cdr lst)))))

(define fold-right (lambda (f acc lst) (if (null? lst) acc
                                                     (f (car lst) (fold-right f acc (cdr lst))))))

(define cons* (lambda(x . y) (if (null? y) x
                                          (letrec ((func (lambda(lst) (if (null? (cdr lst)) (car lst)
